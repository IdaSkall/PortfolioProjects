-- Data Exploration of the two tables CovidDeaths and CovidVaccinations
...
Using CTE to calculate the rolling number of people vaccinated against Covid19 for each location, 
...
------------------------
-- Number of cases and population by location and date
